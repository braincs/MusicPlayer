...
public class MarioResourceUtil {
    ...
    private static MarioResourceUtil mInstance;  //  静态实例对象
    private Context mContext;  // 上下文环境

    private MarioResourceUtil(Context context) {
        setContext(context);
        // 私有化构造方法
    }
     ...
     * 初始化方法
     * @param context
     * @return MarioResourceUtil
     * */
    public static MarioResourceUtil getInstance(@NonNull Context context) {
        if (mInstance == null) {
            synchronized (MarioResourceUtil.class) {
                if (mInstance == null) mInstance = new MarioResourceUtil(context);
            }
        } else {
